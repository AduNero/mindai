...
# Used by apps.common.email_backends.{Resend,SendGrid,Brevo}Backend
# (EMAIL_BACKEND set to one of them on the Render free-tier path, where
# raw SMTP has no outbound route at all — see that module's docstrings).
